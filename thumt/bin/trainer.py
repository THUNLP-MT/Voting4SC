...
def session_config(params):
    ...
    if params.threads_limit:
        config.intra_op_parallelism_threads = params.threads_limit
        config.inter_op_parallelism_threads = params.threads_limit
...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        # Validation
        if params.validation[0] and params.references[0]:
            files = list(params.validation) + list(params.references)
